--[[-------------------------------------------------------------------------
LynxonsRP config settings.
-----------------------------------------------------------------------------

This is the settings file of LynxonsRP. Every LynxonsRP setting is listed here.

Warning:
If this file is missing settings (because of e.g. an update), LynxonsRP will assume default values for these settings.
...
-- The skin LynxonsRP uses. Set to "default" to use the GMod default derma theme.
GM.Config.LynxonsRPSkin = "LynxonsRP"
GM.Config.currency = "$"
GM.Config.currencyThousandSeparator = ","
GM.Config.chatCommandPrefix = "/"

-- The sound that plays when you get a LynxonsRP notification
GM.Config.notificationSound = "buttons/lightswitch2.wav"

-- Put Steam ID's and ranks in this list, and the players will have that rank when they join.
GM.Config.DefaultPlayerGroups = {
    ["STEAM_1:0:190536203"] = "superadmin",
}
...
-- Make sure the category is created in the LynxonsRP_customthings/categories.lua, otherwise it won't work!
GM.Config.CategoryOverride = {
    jobs = {
        ["Гражданский"]                             = "Гражданские",
    },
    entities = {
    },
    shipments = {
