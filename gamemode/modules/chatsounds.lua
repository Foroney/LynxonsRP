...
-- You can add/remove sounds as you wish using LynxonsRP.setChatSound, just follow the format used here
...
LynxonsRP.getChatSound = LynxonsRP.stub{
    name = "getChatSound",
...
function LynxonsRP.getChatSound(text)
    return sounds[string.lower(text or "")]
end

LynxonsRP.setChatSound = LynxonsRP.stub{
    name = "setChatSound",
...
function LynxonsRP.setChatSound(text, sndTable)
