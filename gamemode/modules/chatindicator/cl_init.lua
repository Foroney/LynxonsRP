...
hook.Add("PostPlayerDraw", "LynxonsRP_ChatIndicator", drawIndicator)
hook.Add("CreateClientsideRagdoll", "LynxonsRP_ChatIndicator", function(ent, ragdoll)
...
hook.Add("player_disconnect", "LynxonsRP_ChatIndicator", function(data)
