    ...
    for _, cat in pairs(categories) do
        ...
        dCat:SetPerformLayout(function(contents)
            ...
            for _, v in pairs(contents.Items) do
                local can, important, _, price = canBuy(v.LynxonsRPItem)
...
function PANEL:generateButtons()
    local categories = LynxonsRP.getCategories().entities

    createCategories(self, categories, function(item) RunConsoleCommand("LynxonsRP", item.cmd) end, canBuyEntity)
end
...
function PANEL:generateButtons()
    local categories = LynxonsRP.getCategories().shipments

    createCategories(self, categories, function(item) RunConsoleCommand("LynxonsRP", "buyshipment", item.name) end, canBuyShipment)
end
...
function PANEL:generateButtons()
    local categories = LynxonsRP.getCategories().weapons

    createCategories(self, categories, function(item) RunConsoleCommand("LynxonsRP", "buy", item.name) end, canBuyGun)
end
...
function PANEL:generateButtons()
    local categories = LynxonsRP.getCategories().ammo

    createCategories(self, categories, function(item) RunConsoleCommand("LynxonsRP", "buyammo", item.id) end, canBuyAmmo)
end
...
function PANEL:generateButtons()
    local categories = LynxonsRP.getCategories().vehicles

    createCategories(self, categories, function(item) RunConsoleCommand("LynxonsRP", "buyvehicle", item.command or item.name) end, canBuyVehicle)
end
