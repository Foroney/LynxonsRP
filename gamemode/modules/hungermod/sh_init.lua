...
FoodItems = {}
function LynxonsRP.createFood(name, mdl, energy, price)
    local foodItem = istable(mdl) and mdl or {model = mdl, energy = energy, price = price}
    foodItem.name = name

    if LynxonsRP.LynxonsRP_LOADING and LynxonsRP.disabledDefaults["food"][name] then return end
...
LynxonsRP.getFoodItems = fp{fn.Id, FoodItems}

function LynxonsRP.removeFoodItem(i)
...
LynxonsRP.registerLynxonsRPVar("Energy", net.WriteFloat, net.ReadFloat)

LynxonsRP.createFood("Banana", {
    model = "models/props/cs_italy/bananna.mdl",
    energy = 10,
    price = 10
})
LynxonsRP.createFood("Bunch of bananas", {
    model = "models/props/cs_italy/bananna_bunch.mdl",
    energy = 20,
    price = 20
})
LynxonsRP.createFood("Melon", {
    model = "models/props_junk/watermelon01.mdl",
    energy = 20,
    price = 20
})
LynxonsRP.createFood("Glass bottle", {
    model = "models/props_junk/GlassBottle01a.mdl",
    energy = 20,
    price = 20
})
LynxonsRP.createFood("Pop can", {
    model = "models/props_junk/PopCan01a.mdl",
    energy = 5,
    price = 5
})
LynxonsRP.createFood("Plastic bottle", {
    model = "models/props_junk/garbage_plasticbottle003a.mdl",
    energy = 15,
    price = 15
})
LynxonsRP.createFood("Milk", {
    model = "models/props_junk/garbage_milkcarton002a.mdl",
    energy = 20,
    price = 20
})
LynxonsRP.createFood("Bottle 1", {
    model = "models/props_junk/garbage_glassbottle001a.mdl",
    energy = 10,
    price = 10
})
LynxonsRP.createFood("Bottle 2", {
    model = "models/props_junk/garbage_glassbottle002a.mdl",
    energy = 10,
    price = 10
})
LynxonsRP.createFood("Bottle 3", {
    model = "models/props_junk/garbage_glassbottle003a.mdl",
    energy = 10,
    price = 10
})
LynxonsRP.createFood("Orange", {
