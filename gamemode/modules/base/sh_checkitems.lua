...
local uniqueJob = function(v, tbl)
    local job = LynxonsRP.getJobByCommand(v)
...
LynxonsRP.validateJob = fn.FAnd{baseSchema, tc.checkTable{
    name =
        tc.addHint(
            isstring,
    ...
    ammo =
        tc.addHint(
            ...
            {"See example on https://LynxonsRP.miraheze.org/wiki/LynxonsRP:CustomJobFields"}
        ),
...
LynxonsRP.validateShipment = fn.FAnd{buyableSchema, tc.checkTable{
    name =
        tc.addHint(
            isstring,
            "The name must be a valid string."
...
LynxonsRP.validateVehicle = fn.FAnd{buyableSchema, tc.checkTable{
    name =
        tc.addHint(
            isstring,
...
LynxonsRP.validateEntity = fn.FAnd{buyableSchema, tc.checkTable{
    ent =
        tc.addHint(
            isstring,
...
local overlappingAgendaCheck = function(t, tbl)
    local agenda = LynxonsRP.getAgendas()[t]
...
LynxonsRP.validateAgenda = tc.checkTable{
    Title =
        tc.addHint(
            isstring,
            ...
            fn.FAnd{
                tc.addHint(
                    ...
                    "The Listeners must be a table of existing teams.",
                    {
                        ...
                        [[Like so: LynxonsRP.createAgenda("Some agenda", {TEAM_MANAGER1, TEAM_MANAGER2}, {TEAM_LISTENER1, TEAM_LISTENER2})]]
                    }
                ),
...
LynxonsRP.validateCategory = tc.checkTable{
    name =
        tc.addHint(
            isstring,
