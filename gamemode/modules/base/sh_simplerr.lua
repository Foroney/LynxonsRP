...
if CLIENT then
    ...
    net.Receive("LynxonsRP_simplerrError", function()
    ...
    hook.Add("onSimplerrError", "LynxonsRP_Simplerr", function(err) showError(1, {err}) end)
...
util.AddNetworkString("LynxonsRP_simplerrError")
...
local function sendErrors(plys, errs)
    ...
    LynxonsRP.notify(plys, 1, 120, string.format("There %s %i Lua problem%s!\nPlease check your console for more information!", one and "is" or "are", count, one and "" or 's'))
    net.Start("LynxonsRP_simplerrError")
...
hook.Add("onSimplerrError", "LynxonsRP_Simplerr", annoyAdmins)
...
hook.Add("PlayerInitialSpawn", "LynxonsRP_Simplerr", function(ply) timer.Simple(1, fp{annoyAdmin, ply}) end)
