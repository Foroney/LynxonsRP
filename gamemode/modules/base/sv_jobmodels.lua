util.AddNetworkString("LynxonsRP_preferredjobmodels")
util.AddNetworkString("LynxonsRP_preferredjobmodel")

local preferredJobModels = {}
local plyMeta = FindMetaTable("Player")

local received = {}
net.Receive("LynxonsRP_preferredjobmodels", function(len, ply)
...
net.Receive("LynxonsRP_preferredjobmodel", function(len, ply)
