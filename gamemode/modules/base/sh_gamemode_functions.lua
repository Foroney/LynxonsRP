...
function GM:StartCommand(ply, usrcmd)
    ...
    if wep:IsValid() and isfunction(wep.startLynxonsRPCommand) then
        wep:startLynxonsRPCommand(usrcmd)
    end
end
...
function GM:OnPlayerChangedTeam(ply, oldTeam, newTeam)
    ...
    ply:setSelfLynxonsRPVar("agenda", agenda and agenda.text or nil)
end

hook.Add("loadCustomLynxonsRPItems", "CAMI privs", function()
    CAMI.RegisterPrivilege{
        Name = "LynxonsRP_SeeEvents",
        MinAccess = "admin"
    }

    CAMI.RegisterPrivilege{
        Name = "LynxonsRP_GetAdminWeapons",
        MinAccess = "admin"
    }

    CAMI.RegisterPrivilege{
        Name = "LynxonsRP_SetDoorOwner",
        MinAccess = "admin"
    }

    CAMI.RegisterPrivilege{
        Name = "LynxonsRP_ChangeDoorSettings",
        MinAccess = "superadmin"
    }

    CAMI.RegisterPrivilege{
        Name = "LynxonsRP_AdminCommands",
        MinAccess = "admin"
    }

    CAMI.RegisterPrivilege{
        Name = "LynxonsRP_SetMoney",
        MinAccess = "superadmin"
    }

    CAMI.RegisterPrivilege{
        Name = "LynxonsRP_SetLicense",
        MinAccess = "superadmin"
    }
    ...
    for _, v in pairs(RPExtraTeams) do
        ...
        CAMI.RegisterPrivilege{
            Name = "LynxonsRP_GetJob_" .. v.command,
