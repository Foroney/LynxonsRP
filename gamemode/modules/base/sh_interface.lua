LynxonsRP.registerLynxonsRPVar = LynxonsRP.stub{
    name = "registerLynxonsRPVar",
    description = "Register a LynxonsRPVar by name. You should definitely register LynxonsRPVars. Registering LynxonsRPVars will make networking much more efficient.",
    parameters = {
        {
            name = "name",
            description = "The name of the LynxonsRPVar.",
            type = "string",
            optional = false
        },
        {
            name = "writeFn",
            description = "The function that writes a value for this LynxonsRPVar. Examples: net.WriteString, function(val) net.WriteUInt(val, 8) end.",
            type = "function",
            optional = false
        },
        {
            name = "readFn",
            description = "The function that reads and returns a value for this LynxonsRPVar. Examples: net.ReadString, function() return net.ReadUInt(8) end.",
            type = "function",
            optional = false
        }
    },
...
LynxonsRP.writeNetLynxonsRPVar = LynxonsRP.stub{
    name = "writeNetLynxonsRPVar",
    description = "Internal function. You probably shouldn't need this. LynxonsRP calls this function when sending LynxonsRPVar net messages. This function writes the net data for a specific LynxonsRPVar.",
    parameters = {
        {
            name = "name",
            description = "The name of the LynxonsRPVar.",
        ...
        {
            name = "value",
            description = "The value of the LynxonsRPVar.",
            type = "any",
            optional = false
        }
    },
...
LynxonsRP.writeNetLynxonsRPVarRemoval = LynxonsRP.stub{
    name = "writeNetLynxonsRPVarRemoval",
    description = "Internal function. You probably shouldn't need this. LynxonsRP calls this function when sending LynxonsRPVar net messages. This function sets a LynxonsRPVar to nil.",
    parameters = {
        {
            name = "name",
            description = "The name of the LynxonsRPVar.",
...
LynxonsRP.readNetLynxonsRPVar = LynxonsRP.stub{
    name = "readNetLynxonsRPVar",
    description = "Internal function. You probably shouldn't need this. LynxonsRP calls this function when reading LynxonsRPVar net messages. This function reads the net data for a specific LynxonsRPVar.",
    parameters = {
    },
    returns = {
        {
...
LynxonsRP.readNetLynxonsRPVarRemoval = LynxonsRP.stub{
    name = "readNetLynxonsRPVarRemoval",
    description = "Internal function. You probably shouldn't need this. LynxonsRP calls this function when reading LynxonsRPVar net messages. This function the removal of a LynxonsRPVar.",
    parameters = {
    },
    returns = {
        {
...
LynxonsRP.findPlayer = LynxonsRP.stub{
    name = "findPlayer",
...
LynxonsRP.findPlayers = LynxonsRP.stub{
    name = "findPlayers",
...
LynxonsRP.nickSortedPlayers = LynxonsRP.stub{
...
LynxonsRP.explodeArg = LynxonsRP.stub{
    name = "explodeArg",
...
LynxonsRP.formatMoney = LynxonsRP.stub{
    name = "formatMoney",
...
LynxonsRP.getJobByCommand = LynxonsRP.stub{
...
LynxonsRP.simplerrRun = LynxonsRP.stub{
    name = "simplerrRun",
...
LynxonsRP.error = LynxonsRP.stub{
    name = "error",
    ...
    parameters = {
        ...
        {
            name = "stack",
            description = "From which point in the function call stack to report the error. 1 to include the function that called LynxonsRP.error, 2 to exclude it, etc. The default value is 1.",
            type = "number",
            optional = true
        },
        {
...
LynxonsRP.errorNoHalt = LynxonsRP.stub{
    name = "errorNoHalt",
    description = "Throw a simplerr formatted error. Unlike LynxonsRP.error, this does not halt the stack. This means that statements after calling this function will be executed like normal.",
    parameters = {
        {
            name = "message",
            description = "The message of the error.",
...
LynxonsRP.PLAYER.getJobTable = LynxonsRP.stub{
    name = "getJobTable",
...
LynxonsRP.PLAYER.getLynxonsRPVar = LynxonsRP.stub{
    name = "getLynxonsRPVar",
    description = "Get the value of a LynxonsRPVar, which is shared between server and client.",
    parameters = {
        {
            name = "var",
        ...
        {
            name = "fallback",
            description = "The value to return if the LynxonsRPVar doesn't exist.",
            type = "any",
            optional = true
        }
    },
    returns = {
        {
            name = "value",
            description = "The value of the LynxonsRP var.",
            type = "any"
        }
    },
    metatable = LynxonsRP.PLAYER
...
LynxonsRP.PLAYER.getAgenda = LynxonsRP.stub{
    name = "getAgenda",
...
LynxonsRP.PLAYER.getAgendaTable = LynxonsRP.stub{
    name = "getAgendaTable",
...
LynxonsRP.PLAYER.hasLynxonsRPPrivilege = LynxonsRP.stub{
    name = "hasLynxonsRPPrivilege",
...
LynxonsRP.PLAYER.getEyeSightHitEntity = LynxonsRP.stub{
...
LynxonsRP.VECTOR.isInSight = LynxonsRP.stub{
    name = "isInSight",
...
---------------------------------------------------------------------------]]
LynxonsRP.createJob = LynxonsRP.stub{
    name = "createJob",
    description = "Create a job for LynxonsRP.",
    parameters = {
        {
            name = "name",
...
LynxonsRP.removeJob = LynxonsRP.stub{
    name = "removeJob",
    description = "Remove a job from LynxonsRP.",
    parameters = {
        {
            name = "i",
...
LynxonsRP.removeShipment = LynxonsRP.stub{
    name = "removeShipment",
    description = "Remove a shipment from LynxonsRP. NOTE: Must be called from BOTH server AND client to properly get it removed!",
    parameters = {
        {
            name = "i",
...
LynxonsRP.removeVehicle = LynxonsRP.stub{
    name = "removeVehicle",
    description = "Remove a vehicle from LynxonsRP. NOTE: Must be called from BOTH server AND client to properly get it removed!",
    parameters = {
        {
            name = "i",
            description = "The index of the item.",
...
LynxonsRP.removeEntity = LynxonsRP.stub{
    name = "removeEntity",
    description = "Remove an entity from LynxonsRP. NOTE: Must be called from BOTH server AND client to properly get it removed!",
    parameters = {
        {
            name = "i",
            description = "The index of the item.",
...
LynxonsRP.removeGroupChat = LynxonsRP.stub{
    name = "removeGroupChat",
    description = "Remove a groupchat from LynxonsRP. NOTE: Must be called from BOTH server AND client to properly get it removed!",
    parameters = {
        {
            name = "i",
            description = "The index of the item.",
...
LynxonsRP.removeAmmoType = LynxonsRP.stub{
    name = "removeAmmoType",
    description = "Remove an ammotype from LynxonsRP. NOTE: Must be called from BOTH server AND client to properly get it removed!",
    parameters = {
        {
            name = "i",
            description = "The index of the item.",
...
LynxonsRP.removeEntityGroup = LynxonsRP.stub{
    name = "removeEntityGroup",
    description = "Remove an entitygroup from LynxonsRP. NOTE: Must be called from BOTH server AND client to properly get it removed!",
    parameters = {
        {
            name = "name",
...
LynxonsRP.removeAgenda = LynxonsRP.stub{
    name = "removeAgenda",
    description = "Remove a agenda from LynxonsRP. NOTE: Must be called from BOTH server AND client to properly get it removed!",
    parameters = {
        {
            name = "name",
            description = "The name of the item.",
...
LynxonsRP.removeDemoteGroup = LynxonsRP.stub{
    name = "removeDemoteGroup",
    description = "Remove an demotegroup from LynxonsRP. NOTE: Must be called from BOTH server AND client to properly get it removed!",
    parameters = {
        {
            name = "name",
            description = "The name of the item.",
...
LynxonsRP.createEntityGroup = LynxonsRP.stub{
    name = "createEntityGroup",
    description = "Create a entity group for LynxonsRP.",
    parameters = {
        {
            name = "name",
...
LynxonsRP.createShipment = LynxonsRP.stub{
    name = "createShipment",
    description = "Create a shipment for LynxonsRP.",
    parameters = {
        {
            name = "name",
...
LynxonsRP.createVehicle = LynxonsRP.stub{
    name = "createVehicle",
    description = "Create a vehicle for LynxonsRP.",
    parameters = {
        {
            name = "name",
...
LynxonsRP.createEntity = LynxonsRP.stub{
    name = "createEntity",
    description = "Create a entity for LynxonsRP.",
    parameters = {
        {
            name = "name",
...
AddCustomVehicle = LynxonsRP.createEntity

LynxonsRP.createAgenda = LynxonsRP.stub{
    name = "createAgenda",
...
LynxonsRP.getAgendas = LynxonsRP.stub{
    name = "getAgendas",
...
LynxonsRP.createGroupChat = LynxonsRP.stub{
...
GM.AddGroupChat = LynxonsRP.createGroupChat

LynxonsRP.createAmmoType = LynxonsRP.stub{
    name = "createAmmoType",
...
LynxonsRP.createDemoteGroup = LynxonsRP.stub{
...
LynxonsRP.getDemoteGroup = LynxonsRP.stub{
    name = "getDemoteGroup",
...
LynxonsRP.getGroupChats = LynxonsRP.stub{
    name = "getGroupChats",
...
LynxonsRP.getDemoteGroups = LynxonsRP.stub{
...
LynxonsRP.createCategory = LynxonsRP.stub{
    name = "createCategory",
...
LynxonsRP.addToCategory = LynxonsRP.stub{
    name = "addToCategory",
    description = "Create a category for the F4 menu.",
    parameters = {
        {
...
LynxonsRP.removeFromCategory = LynxonsRP.stub{
...
LynxonsRP.getCategories = LynxonsRP.stub{
    name = "getCategories",
...
LynxonsRP.ValidatedPhysicsInit = LynxonsRP.stub{
...
LynxonsRP.hookStub{
    name = "LynxonsRPVarChanged",
    description = "Called when a LynxonsRPVar was changed.",
    parameters = {
        {
            name = "ply",
            description = "The player for whom the LynxonsRPVar changed.",
            type = "Player"
        },
        {
            name = "varname",
        ...
        {
            name = "oldValue",
            description = "The old value of the LynxonsRPVar.",
            type = "any"
        },
        {
            name = "newvalue",
            description = "The new value of the LynxonsRPVar.",
            type = "any"
        }
    },
    returns = {
...
LynxonsRP.hookStub{
    name = "loadCustomLynxonsRPItems",
    description = "Runs right after the scripts from the LynxonsRPMod are run. You can add custom jobs, entities, shipments and whatever in this hook.",
    parameters = {
    },
    returns = {
    }
...
LynxonsRP.hookStub{
    name = "postLoadCustomLynxonsRPItems",
    description = "Runs right after loadCustomLynxonsRPItems. All custom LynxonsRP content will be loaded by this time.",
    parameters = {
    },
    returns = {
    }
...
LynxonsRP.hookStub{
    name = "LynxonsRPStartedLoading",
    description = "Runs at the very start of loading LynxonsRP. Not even sandbox has loaded here yet.",
    parameters = {
    },
    returns = {
    }
...
LynxonsRP.hookStub{
    name = "LynxonsRPFinishedLoading",
    description = "Runs right after LynxonsRP itself has loaded. All LynxonsRPMod stuff (except for disabled_defaults) is loaded during this hook. NOTE! NO CUSTOM STUFF WILL BE AVAILABLE DURING THIS HOOK. USE `loadCustomLynxonsRPItems` INSTEAD IF YOU WANT THAT!",
    parameters = {
    },
    returns = {
    }
