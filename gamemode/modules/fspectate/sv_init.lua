...
local vrad = LynxonsRP and GM.Config.voiceradius
local voiceDistance = LynxonsRP and GM.Config.voiceDistance * GM.Config.voiceDistance or 302500 -- Default 550 units
...
local function playerSay(talker, message)
    ...
    if not LynxonsRP then return end
    ...
    for _, ply in ipairs(player.GetAll()) do
        ...
        if
            ...
            LynxonsRP.talkToPerson(ply, talkerTeam, talkerName, col, message, talker)
            return
        end
    end
end
