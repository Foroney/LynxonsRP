...
FPP.AddDefaultBlocked("Spawning1", "LynxonsRP_laws")

hook.Add("LynxonsRPDBInitialized", "FPPInit", function()
	FPP.Init()

	-- Migrate database.
	-- Previous versions of the database don't store the default blocked.
	-- Store them now
	if not LynxonsRP.DBVersion or LynxonsRP.DBVersion < 20150725 then
