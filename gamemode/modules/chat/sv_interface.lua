LynxonsRP.defineChatCommand = LynxonsRP.stub{
...
LynxonsRP.definePrivilegedChatCommand = LynxonsRP.stub{
...
LynxonsRP.hookStub{
    name = "canChatCommand",
    description = "Called when a player tries to run any chat command or uses the LynxonsRP console command. ",
    parameters = {
        {
            name = "ply",
            description = "The player who spoke.",
...
LynxonsRP.hookStub{
    name = "onChatCommand",
    description = "Called after a player has run any chat command or uses the LynxonsRP console command. Note: the chat command has already been run. Use canChatCommand if you want to stop chat commands from being run.",
    parameters = {
        {
            name = "ply",
            description = "The player who spoke.",
