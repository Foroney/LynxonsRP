...
LynxonsRP.tipJarUIModel = {}

--[[-------------------------------------------------------------------------
Update the model.
Automatically calls the registered update hook functions
---------------------------------------------------------------------------]]
function LynxonsRP.tipJarUIModel.updateModel(path, value, ...)
...
---------------------------------------------------------------------------]]
function LynxonsRP.tipJarUIModel.getModelValue(path)
    path = istable(path) and path or {path}
...
updated
---------------------------------------------------------------------------]]
function LynxonsRP.tipJarUIModel.onModelUpdate(path, func)
    path = istable(path) and path or {path}
...
onModelUpdate("amount", function(new, _)
    ...
    local ownMoney = localply:getLynxonsRPVar("money") or 0
