...
= Warning =
Sometimes when LynxonsRP is updated, new phrases are added.
...
local my_language = {
    ...
    see_settings = "Please see the LynxonsRP settings.",
    ...
    credits_see_console = "LynxonsRP credits printed to console.",
    ...
    change_name = "Change your LynxonsRP name",
...
LynxonsRP.addLanguage("en", my_language)
