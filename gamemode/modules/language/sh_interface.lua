LynxonsRP.addLanguage = LynxonsRP.stub{
    name = "addLanguage",
...
LynxonsRP.addPhrase = LynxonsRP.stub{
    name = "addPhrase",
...
LynxonsRP.getPhrase = LynxonsRP.stub{
    name = "getPhrase",
...
LynxonsRP.getMissingPhrases = LynxonsRP.stub{
...
LynxonsRP.addChatCommandsLanguage = LynxonsRP.stub{
    name = "addChatCommandsLanguage",
    description = "Add a translation table for chat command descriptions. See LynxonsRPmod/lua/LynxonsRP_language/chatcommands.lua for an example.",
    parameters = {
        {
            name = "languageCode",
            description = "The language code of the language. For English this is \"en\".",
...
LynxonsRP.getChatCommandDescription = LynxonsRP.stub{
