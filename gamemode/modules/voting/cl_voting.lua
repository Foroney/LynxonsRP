...
local function MsgDoVote(msg)
    ...
    panel:SetTitle(LynxonsRP.getPhrase("vote"))
    ...
    function panel:Think()
        self:SetTitle(LynxonsRP.getPhrase("time", math.Clamp(math.ceil(timeleft - (CurTime() - OldTime)), 0, 9999)))
    ...
    label:SetPos(5, 25)
    label:SetText(LynxonsRP.textWrap(LynxonsRP.deLocalise(question), "DermaDefault", 130))
    ...
    ybutton:SetCommand("!")
    ybutton:SetText(LynxonsRP.getPhrase("yes"))
    ...
    nbutton:SetCommand("!")
    nbutton:SetText(LynxonsRP.getPhrase("no"))
    ...
    panel:SetSkin(GAMEMODE.Config.LynxonsRPSkin)
end
...
local function MsgDoQuestion(msg)
    ...
    label:SetText(LynxonsRP.deLocalise(question))
    label:SetVisible(true)
