-- Skin for LynxonsRP gui's
SKIN = {}

SKIN.PrintName          = "LynxonsRP"
SKIN.Author             = "Underground Lynx"
SKIN.DermaVersion       = 1
SKIN.GwenTexture        = Material("LynxonsRP/LynxonsRPderma.png")
...
derma.DefineSkin("LynxonsRP", "The official SKIN for LynxonsRP", SKIN)
