...
net.Receive("LynxonsRP_shipmentSpawn", function()
...
function ENT:drawInfo()
    ...
    local text = LynxonsRP.getPhrase("contents")
    ...
    text = LynxonsRP.getPhrase("amount")
...
{
    MenuLabel   =   LynxonsRP.getPhrase("splitshipment"),
    Order       =   2004,
    ...
    Action      =   function(self, ent)
                        ...
                        RunConsoleCommand("LynxonsRP", "splitshipment", ent:EntIndex())
                    end
})
