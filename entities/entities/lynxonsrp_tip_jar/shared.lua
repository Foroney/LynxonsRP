...
function ENT:UpdateActiveDonation(ply, amount)
    ...
    hook.Call("tipjarUpdateActiveDonation", LynxonsRP.hooks, self, ply, amount, old)
end
...
function ENT:ExitActiveDonation(ply)
    ...
    self:PruneActiveDonations()
    hook.Call("tipjarExitActiveDonation", LynxonsRP.hooks, self, ply, old)
...
function ENT:ClearActiveDonations()
    ...
    hook.Call("tipjarClearActiveDonation", LynxonsRP.hooks, self)
end
