...
function ENT:Draw()
    ...
    cam.Start3D2D(DrawPos, DrawAngles, 0.4)
        ...
        draw.DrawNonParsedSimpleText(LynxonsRP.getPhrase("laws_of_the_land"), "Roboto20", 279, 5, color_red, TEXT_ALIGN_CENTER)
...
local function addLaw(inLaw)
    local law = LynxonsRP.textWrap(inLaw, "Roboto20", 522)
