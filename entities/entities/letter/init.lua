...
concommand.Add("_LynxonsRP_SignLetter", function(ply, cmd, args)
...
local function removeLetters(ply, args)
    ...
    if ply:EntIndex() == 0 then
        LynxonsRP.log("Console force-removed all letters", Color(30, 30, 30))
    else
        LynxonsRP.log(ply:Nick() .. " (" .. ply:SteamID() .. ") force-removed all letters", Color(30, 30, 30))
    end

    LynxonsRP.notify(ply, 0, 4, "All letters removed")
end
LynxonsRP.definePrivilegedChatCommand("removeletters", "LynxonsRP_AdminCommands", removeLetters)
